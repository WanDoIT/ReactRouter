...
const NewsList = () => {
    ...
    //1.API데이터 가져오기
    //7f990577df9c4fd88960e3983d4d5302
    ...
    useEffect(() => {
        ...
        (async () => {
            const url = `https://newsapi.org/v2/top-headlines?country=kr${query}&apiKey=7f990577df9c4fd88960e3983d4d5302`
    ...
    // console.log(data);
    //3. 데이터로딩처리 ( 데이터가 오기전에 state는 undefined)
